...
static void initialize(void)
{
    ...
    if (kernel32 != NULL) {
	CreateHardLinkFunc =
	    (CreateHardLinkFuncType) GetProcAddress(kernel32,
						    "CreateHardLinkA");
    }
    initialized = TRUE;
}
...
int rpl_link(char const *file1, char const *file2)
{
    size_t len1;
    size_t len2;
    struct stat st;
    ...
    len1 = new_strlen(file1);
    len2 = new_strlen(file2);
