...
int rpl_renameat(int fd1, char const *src, int fd2, char const *dst)
{
    size_t src_len = new_strlen(src);
    size_t dst_len = new_strlen(dst);
...
int renameat(int fd1, char const *file1, int fd2, char const *file2)
{
