...
static inline void clear_ungetc_buffer(FILE * fp)
{
...
static inline int disable_seek_optimization(FILE * fp)
{
...
static inline void restore_seek_optimization(FILE * fp, int saved_flags)
{
    fp_->_flags = (fp_->_flags & ~(__SOPT | __SNPT)) | saved_flags;
}
#endif
static inline void update_fpos_cache(FILE * fp, off_t pos)
{
#if defined __sferror || defined __DragonFly__	/* FreeBSD, NetBSD, OpenBSD, DragonFly, MacOS X, Cygwin */
...
int rpl_fflush(FILE * stream)
{
	...
	/* Notes about the file-position indicator:
	   1) The file position indicator is incremented by new_fgetc() and decremented
	   by ungetc():
	   <http://www.opengroup.org/susv3/functions/fgetc.html>
	   "... the new_fgetc() function shall ... advance the associated file
