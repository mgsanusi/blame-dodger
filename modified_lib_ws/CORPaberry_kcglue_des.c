 ...
 */
int
kcglue_des_key_sched (void *akey, void *asched)
{
  return des_key_sched (akey, asched);
}

void
kcglue_des_ecb_encrypt (void *asrc, void *adest, void *asched, int direction)
{
  des_ecb_encrypt (asrc, adest, asched, direction);
}

void
kcglue_des_pcbc_encrypt (void *asrc, void *adest, long length, void *asched,
			 void *akey, int direction)
{
