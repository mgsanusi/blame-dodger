...
#else
#define ISSPACE(Ch) new_isspace (Ch)
#define ISALPHA(Ch) new_isalpha (Ch)
#define TOUPPER(Ch) new_toupper (Ch)
#endif
#endif
...
INT
  ...
  weak_function
#endif
new_strtol (const STRING_TYPE * nptr, STRING_TYPE ** endptr,
	    int base LOCALE_PARAM_PROTO)
{
  return INTERNAL (strtol) (nptr, endptr, base, 0 LOCALE_PARAM);
}

long long int new_toupper (int c);
