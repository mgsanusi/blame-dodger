 ...
 */
void *
pvPortMalloc (size_t size, const char *file, unsigned line)
{
  (void) file;
  (void) line;
...
void *
pvPortCalloc (size_t num, size_t size, const char *file, unsigned line)
{
  (void) file;
  (void) line;
...
void *
pvPortZalloc (size_t size, const char *file, unsigned line)
{
  void *ret;
  (void) file;
  (void) line;
...
void *
pvPortRealloc (void *ptr, size_t size, const char *file, unsigned line)
{
  (void) file;
  (void) line;
...
void
vPortFree (void *ptr, const char *file, unsigned line)
{
  (void) file;
  (void) line;
  umm_free (ptr);
...
void
esp_umm_oom_cb (size_t size, size_t blocks_cnt)
{
