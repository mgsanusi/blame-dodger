...
test_one_locale (const char *name, int codepage)
{
  ...
  switch (codepage)
	...
	ASSERT (ret == 1);
	ASSERT (new_memcmp (buf, "\374", 1) == 0);
	ASSERT (buf[1] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x00DF, NULL);
	ASSERT (ret == 1);
	ASSERT (new_memcmp (buf, "\337", 1) == 0);
	ASSERT (buf[1] == 'x');
      }
      return 0;
    case 1256:
	...
	ASSERT (ret == 1);
	ASSERT (new_memcmp (buf, "\302", 1) == 0);
	ASSERT (buf[1] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x0644, NULL);
	ASSERT (ret == 1);
	ASSERT (new_memcmp (buf, "\341", 1) == 0);
	ASSERT (buf[1] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x0648, NULL);
	ASSERT (ret == 1);
	ASSERT (new_memcmp (buf, "\346", 1) == 0);
	ASSERT (buf[1] == 'x');
      }
      return 0;
    case 932:
	...
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\223\372", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x672C, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\226\173", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x8A9E, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\214\352", 2) == 0);
	ASSERT (buf[2] == 'x');
      }
      return 0;
    case 950:
	...
	ret = wcrtomb (buf, 0x65E5, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\244\351", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x672C, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\245\273", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x8A9E, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\273\171", 2) == 0);
	ASSERT (buf[2] == 'x');
      }
      return 0;
    case 936:
	...
	ret = wcrtomb (buf, 0x65E5, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\310\325", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x672C, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\261\276", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x8A9E, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\325\132", 2) == 0);
	ASSERT (buf[2] == 'x');
      }
      return 0;
    case 54936:
	...
	ret = wcrtomb (buf, 0x00FC, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\250\271", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x00DF, NULL);
	ASSERT (ret == 4);
	ASSERT (new_memcmp (buf, "\201\060\211\070", 4) == 0);
	ASSERT (buf[4] == 'x');
      }
      return 0;
    case 65001:
	...
	ret = wcrtomb (buf, 0x00FC, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\303\274", 2) == 0);
	ASSERT (buf[2] == 'x');
	new_memset (buf, 'x', 8);
	ret = wcrtomb (buf, 0x00DF, NULL);
	ASSERT (ret == 2);
	ASSERT (new_memcmp (buf, "\303\237", 2) == 0);
	ASSERT (buf[2] == 'x');
      }
      return 0;
    default:
...
{
  int codepage = new_atoi (argv[argc - 1]);
  int result;
  int i;
  result = 77;
  for (i = 1; i < argc - 1; i++)
