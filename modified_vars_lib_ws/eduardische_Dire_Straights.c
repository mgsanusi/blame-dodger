...
double find_s(struct coord f[105], int old_m, struct coord b[105], int ctx,
	      double l)
{
    cc = 0;
    dc = 0;
    ...
    v--;
    if (new_fabs(((double) f[v].x) - l) >= 1E-9) {
	double l2 =
	    ((double) f[v].t) +
	    (((l -
	       ((double) f[v].x)) / ((double) (f[v + 1].x -
					       f[v].x))) * ((double) (f[v +
									1].
								      t -
								      f[v].
    ...
    v--;
    if (new_fabs(((double) b[v].x) - l) >= 1E-9) {
	double l2 =
	    ((double) b[v].t) +
	    (((l -
	       ((double) b[v].x)) / ((double) (b[v + 1].x -
					       b[v].x))) * ((double) (b[v +
									1].
								      t -
								      b[v].
