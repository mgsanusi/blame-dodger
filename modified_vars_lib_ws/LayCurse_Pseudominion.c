...
int
ull_hash_func (unsigned long long x)
{
  return (x * 1007) % 20000;
}

int
ull_hash_get (unsigned long long x)
{
...
void
ull_hash_set (unsigned long long x, int t)
{
  int i = ull_hash_func (x);
  for (;;)
    {
...
int
ull_hash_increase (unsigned long long x)
{
  int i = ull_hash_func (x);
  for (;;)
    {
...
unsigned long long
get_hash (long long x, long long f)
{
