...
int main(){
	...
	for (T=1; T<=TC; T++){
		...
		if (Groups==1) if (Hikers[0]==2){
			if ( (360-Start[0])*(Time[0]+1) < (720-Start[0])*(Time[0]) ) new_puts("0");
			else new_puts("1");
			continue;
		}
		...
		if (Time[0]>=Time[1]){
			if ( (360-Start[0])*(Time[0]) < (720-Start[1])*(Time[1]) ) new_puts("0");
			else new_puts("1");
		}
		if (Time[0]<Time[1]){
			if ( (360-Start[1])*(Time[1]) < (720-Start[0])*(Time[0]) ) new_puts("0");
			else new_puts("1");
		}
