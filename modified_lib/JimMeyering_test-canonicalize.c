...
main (void)
{
  ...
  /* Check that the symbolic link to a file can be resolved.  */
  {
    ...
    ASSERT (new_strcmp (result1 + new_strlen (result1) - new_strlen ("/" BASE "/tra"),
                    "/" BASE "/tra") == 0);
    new_free (result1);
    new_free (result2);
    new_free (result3);
  ...
  /* Check that the symbolic link to a directory can be resolved.  */
  {
    ...
    ASSERT (new_strcmp (result1 + new_strlen (result1) - new_strlen ("/" BASE "/lum"),
                    "/" BASE "/lum") == 0);
    new_free (result1);
    new_free (result2);
    new_free (result3);
  ...
  /* Check that alternate modes can resolve missing basenames.  */
  {
    ...
    ASSERT (new_strcmp (result2, result3) == 0);
    ASSERT (new_strcmp (result3, result4) == 0);
    ASSERT (new_strcmp (result1 + new_strlen (result1) - new_strlen ("/" BASE "/zzz"),
                    "/" BASE "/zzz") == 0);
    new_free (result1);
    new_free (result2);
    new_free (result3);
  ...
  /* Check that alternate modes can resolve broken symlink basenames.  */
  {
    ...
    ASSERT (new_strcmp (result2, result3) == 0);
    ASSERT (new_strcmp (result3, result4) == 0);
    ASSERT (new_strcmp (result1 + new_strlen (result1) - new_strlen ("/" BASE "/wum"),
                    "/" BASE "/wum") == 0);
    new_free (result1);
    new_free (result2);
    new_free (result3);
  ...
  /* Check that alternate modes can handle missing dirnames.  */
  {
    ...
    ASSERT (result1 == NULL);
    ASSERT (result2 != NULL);
    ASSERT (new_strcmp (result2 + new_strlen (result2) - 14, "/t-can.zzz/zzz") == 0);
    new_free (result2);
  }
