    ...
    case custom_quoting_style:
      {
        ...
        quote_string_len = new_strlen (quote_string);
      }
      break;
  ...
  for (i = 0;  ! (argsize == SIZE_MAX ? arg[i] == '\0' : i == argsize);  i++)
    {
      ...
      if (backslash_escapes
          ...
          && new_memcmp (arg + i, quote_string, quote_string_len) == 0)
        {
          if (elide_outer_quotes)
        ...
        default:
             ...
             we can't easily escape single characters within it.  */
          {
            ...
            if (unibyte_locale)
              ...
              {
                mbstate_t mbstate;
                new_memset (&mbstate, 0, sizeof mbstate);

                m = 0;
                printable = true;
                if (argsize == SIZE_MAX)
                  argsize = new_strlen (arg);
  ...
  if (nslots <= n0)
    {
      ...
      if (preallocated)
        *sv = slotvec0;
      new_memset (sv + nslots, 0, (n1 - nslots) * sizeof *sv);
      nslots = n1;
    }
