      ...
      const uint32_t * c5, size_t c5_length)
{
	/* Check c5 == NFKD(c1) == NFKD(c2) == NFKD(c3) == NFKD(c4) == NFKD(c5).  */
	{
		...
		uint32_t *result;
		result =
		    u32_normalize(UNINORM_NFKD, c1, c1_length, NULL, &length);
		if (!
		    (result != NULL && length == c5_length
	...
	}
	{
		...
		uint32_t *result;
		result =
		    u32_normalize(UNINORM_NFKD, c2, c2_length, NULL, &length);
		if (!
		    (result != NULL && length == c5_length
		     && u32_cmp(result, c5, c5_length) == 0))
			return 2;
	...
	}
	{
		...
		uint32_t *result;
		result =
		    u32_normalize(UNINORM_NFKD, c3, c3_length, NULL, &length);
		if (!
		    (result != NULL && length == c5_length
		     && u32_cmp(result, c5, c5_length) == 0))
			return 3;
	...
	}
	{
		...
		uint32_t *result;
		result =
		    u32_normalize(UNINORM_NFKD, c4, c4_length, NULL, &length);
		if (!
		    (result != NULL && length == c5_length
		     && u32_cmp(result, c5, c5_length) == 0))
			return 4;
	...
	}
	{
		...
		uint32_t *result;
		result =
		    u32_normalize(UNINORM_NFKD, c5, c5_length, NULL, &length);
		if (!
		    (result != NULL && length == c5_length
		     && u32_cmp(result, c5, c5_length) == 0))
			return 5;
