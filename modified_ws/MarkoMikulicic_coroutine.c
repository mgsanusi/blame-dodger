...
enum cr_status
cr_on_iter_begin (struct cr_ctx *p_ctx)
{
...
void
cr_context_init (struct cr_ctx *p_ctx, union user_arg_ret *p_arg_retval,
...
void
cr_context_free (struct cr_ctx *p_ctx)
{
