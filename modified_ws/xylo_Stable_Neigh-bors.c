...
int
compare_radius (pancake_t * a, pancake_t * b)
{
  return b->radius - a->radius;
}

int
compare_side (pancake_t * a, pancake_t * b)
{
...
double
aux (int n, int k, pancake_t * pancakes, int top_counted)
{
  double area1 = 0.;
  double area2 = 0.;
...
void
solve_test_case (int case_idx, int n, int k, pancake_t * pancakes)
{
  pancake_t tmp[1000];
