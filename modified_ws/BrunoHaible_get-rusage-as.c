...
static inline uintptr_t get_rusage_as_via_setrlimit(void)
{
	uintptr_t result;
...
static inline uintptr_t get_rusage_as_via_iterator(void)
{
	uintptr_t total = 0;
