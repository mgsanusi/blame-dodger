...
int64_t
combat_duration (int hd, int ad,
		 int hk, int ak, int b, int d, int n_debuffs, int n_buffs)
{
  int dragon_hp = hd;
  int knight_hp = hk;
...
void
solve_test_case (int case_idx, int hd, int ad, int hk, int ak, int b, int d)
{
