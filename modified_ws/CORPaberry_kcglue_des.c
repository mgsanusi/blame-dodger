...
void kcglue_des_ecb_encrypt(void *asrc, void *adest, void *asched,
			    int direction)
{
    des_ecb_encrypt(asrc, adest, asched, direction);
}

void kcglue_des_pcbc_encrypt(void *asrc, void *adest, long length,
			     void *asched, void *akey, int direction)
{
