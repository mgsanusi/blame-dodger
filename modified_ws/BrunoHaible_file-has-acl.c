  ...
  if (old_convention)
	...
	return 1;
      ...
      if ((NEW_ACE_WRITE_NAMED_ATTRS
	   ...
	   | NEW_ACE_WRITE_ACL | NEW_ACE_WRITE_OWNER) & ~access_masks[1])
	return 1;
      ...
      if ((NEW_ACE_WRITE_NAMED_ATTRS
	   | NEW_ACE_WRITE_ATTRIBUTES
	   | NEW_ACE_WRITE_ACL | NEW_ACE_WRITE_OWNER) & ~access_masks[4])
	return 1;
      ...
      if ((NEW_ACE_READ_NAMED_ATTRS
	   ...
	   | NEW_ACE_READ_ACL | NEW_ACE_SYNCHRONIZE) & ~access_masks[5])
	return 1;
      ...
      if ((access_masks[0] | access_masks[1])
	  != (NEW_ACE_READ_DATA
	      | NEW_ACE_WRITE_DATA | NEW_ACE_APPEND_DATA | NEW_ACE_EXECUTE))
	return 1;
      if ((access_masks[2] | access_masks[3])
	  != (NEW_ACE_READ_DATA
	      | NEW_ACE_WRITE_DATA | NEW_ACE_APPEND_DATA | NEW_ACE_EXECUTE))
