...
void
mgos_system_restart_after (int delay_ms)
{
...
float
mgos_rand_range (float from, float to)
{
 ...
 */
void
mgos_log (const char *filename, int line_no, int level, const char *msg)
{
