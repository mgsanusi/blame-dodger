...
#else
	m.word[FLT_EXPBIT0_WORD +
	       (FLT_EXPBIT0_WORD < NWORDSF / 2 ? 1 : -1)]
...
#else
	m.word[DBL_EXPBIT0_WORD +
	       (DBL_EXPBIT0_WORD < NWORDSD / 2 ? 1 : -1)]
	    ^= (unsigned int) 1 << (sizeof(unsigned int) * CHAR_BIT - 1);
#endif
	m.word[DBL_EXPBIT0_WORD +
	       (DBL_EXPBIT0_WORD < NWORDSD / 2 ? 1 : -1)]
...
#else
	m.word[LDBL_EXPBIT0_WORD +
	       (LDBL_EXPBIT0_WORD < NWORDSL / 2 ? 1 : -1)]
	    ^= (unsigned int) 1 << (sizeof(unsigned int) * CHAR_BIT - 1);
#endif
	m.word[LDBL_EXPBIT0_WORD +
	       (LDBL_EXPBIT0_WORD < NWORDSL / 2 ? 1 : -1)]
