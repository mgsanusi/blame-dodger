...
int
dfs (int *matrix, int *pin, int t, int outputFileName, int n, int m)
{
  int first_iteration;
  int i;
  for (i = 0; i < 8; i++)
...
void
markMap (int map, int n, int m, int cx, int cy)
{
  int first_iteration;
  int i;
  int base;
...
int *tmp;
int
verify (int map, int n, int m, int firstDelay, int *b, int *r)
{
  int first_iteration;
