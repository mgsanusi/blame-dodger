...
extern AUTH *gssrpc_authunix_create(char *machname, int uid, int gid, int len,
				    int *aup_gids);
...
typedef struct CLIENT {
	AUTH *cl_auth;
	struct clnt_ops {
		enum clnt_stat (*cl_call) (struct CLIENT *, rpcproc_t,
...
extern CLIENT *gssrpc_clnttcp_create(struct sockaddr_in *, rpcprog_t, rpcvers_t,
				     int *, u_int, u_int);
extern CLIENT *gssrpc_clntudp_create(struct sockaddr_in *, rpcprog_t, rpcvers_t,
				     struct timeval, int *);
...
OM_uint32 gss_get_mic(OM_uint32 *, gss_ctx_id_t, gss_qop_t, gss_buffer_t,
		      gss_buffer_t);
OM_uint32 gss_verify_mic(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t,
			 gss_qop_t *);
...
OM_uint32 gss_unwrap(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t,
		     int *, gss_qop_t *);
OM_uint32 gss_display_status(OM_uint32 *, OM_uint32, int, gss_OID, OM_uint32 *,
			     gss_buffer_t);
...
OM_uint32 gss_inquire_context(OM_uint32 *, gss_ctx_id_t, gss_name_t *,
			      gss_name_t *, OM_uint32 *, gss_OID *, OM_uint32 *,
			      int *, int *);
...
OM_uint32 gss_canonicalize_name(OM_uint32 *, const gss_name_t, const gss_OID,
				gss_name_t *);
OM_uint32 gss_pseudo_random(OM_uint32 *, gss_ctx_id_t, int, const gss_buffer_t,
...
OM_uint32 gss_indicate_mechs_by_attrs(OM_uint32 *, gss_const_OID_set,
				      ...
				      gss_OID_set *);
OM_uint32 gss_inquire_attrs_for_mech(OM_uint32 *, gss_const_OID, gss_OID_set *,
				     gss_OID_set *);
