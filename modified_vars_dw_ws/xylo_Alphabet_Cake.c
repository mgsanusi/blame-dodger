...
int64_t
combatDuration (int spend, int ad, int hk, int wp, int buf, int d,
...
void
clearTestCase (int caseIdx, int spend, int ad, int hk, int wp, int buf, int d)
{
  int first_iteration;
