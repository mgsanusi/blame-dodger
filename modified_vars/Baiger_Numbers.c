...
int Main()
{
  ...
  for (i = 1; i <= tosort; i++)
  {
    ...
    {
      f[cval][0] = calc0(f[cval * 2][0], f[cval * 2][1], f[(cval * 2) + 1][0], f[(cval * 2) + 1][1], g[cval], x[cval]);
      f[cval][1] = calc1(f[cval * 2][0], f[cval * 2][1], f[(cval * 2) + 1][0], f[(cval * 2) + 1][1], g[cval], x[cval]);
    }
