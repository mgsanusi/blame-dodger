...
typedef enum {RPCSEC_GSS_DATA = 0, RPCSEC_GSS_INIT = 1, RPCSEC_GSS_CONTINUE_INIT = 2, RPCSEC_GSS_DESTROY = 3} rpcGssProcT;
...
extern void gssrpcXdrrecMake(XDR *xdrs, u_int, u_int, caddr_t, int (*)(caddr_t, caddr_t, int), int (*)(caddr_t, caddr_t, int));
...
typedef struct CLIENT
{
  ...
  struct clnt_ops
  {
    enum clnt_stat (*clName)(struct CLIENT *, rpcproc_t, xdrproc_t, void *, xdrproc_t, void *, struct timeval);
...
OM_uint32 gssAcquireCred(OM_uint32 *, gss_name_t, OM_uint32, gss_OID_set, gss_cred_usage_t, gss_cred_id_t *, gss_OID_set *, OM_uint32 *);
OM_uint32 gssReleaseCred(OM_uint32 *, gss_cred_id_t *);
OM_uint32 gInitSecContext(OM_uint32 *, gss_cred_id_t, gss_ctx_id_t *, gss_name_t, gss_OID, OM_uint32, OM_uint32, gss_channel_bindings_t, gss_buffer_t, gss_OID *, gss_buffer_t, OM_uint32 *, OM_uint32 *);
OM_uint32 gssAcceptSecContext(OM_uint32 *, gss_ctx_id_t *, gss_cred_id_t, gss_buffer_t, gss_channel_bindings_t, gss_name_t *, gss_OID *, gss_buffer_t, OM_uint32 *, OM_uint32 *, gss_cred_id_t *);
...
OM_uint32 gGetMic(OM_uint32 *, gss_ctx_id_t, gss_qop_t, gss_buffer_t, gss_buffer_t);
OM_uint32 gssVerifyMic(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t, gss_qop_t *);
OM_uint32 gWrap(OM_uint32 *, gss_ctx_id_t, int, gss_qop_t, gss_buffer_t, int *, gss_buffer_t);
OM_uint32 gUnwrap(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t, int *, gss_qop_t *);
OM_uint32 gssDisplayStatus(OM_uint32 *, OM_uint32, int, gss_OID, OM_uint32 *, gss_buffer_t);
...
OM_uint32 gInquireContext(OM_uint32 *, gss_ctx_id_t, gss_name_t *, gss_name_t *, OM_uint32 *, gss_OID *, OM_uint32 *, int *, int *);
...
OM_uint32 gssAddCred(OM_uint32 *, gss_cred_id_t, gss_name_t, gss_OID, gss_cred_usage_t, OM_uint32, OM_uint32, gss_cred_id_t *, gss_OID_set *, OM_uint32 *, OM_uint32 *);
OM_uint32 gInquireCredByMech(OM_uint32 *, gss_cred_id_t, gss_OID, gss_name_t *, OM_uint32 *, OM_uint32 *, gss_cred_usage_t *);
...
OM_uint32 gSeal(OM_uint32 *, gss_ctx_id_t, int, int, gss_buffer_t, int *, gss_buffer_t);
OM_uint32 gssUnseal(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t, int *, int *);
...
OM_uint32 gPseudoRandom(OM_uint32 *, gss_ctx_id_t, int, const gss_buffer_t, ssize_t, gss_buffer_t);
...
typedef const gss_OID_desc *gssConstOid;
typedef const gss_OID_set_desc *gssConstOidSet;
OM_uint32 gIndicateMechsByAttrs(OM_uint32 *, gss_const_OID_set, gss_const_OID_set, gss_const_OID_set, gss_OID_set *);
OM_uint32 gInquireAttrsForMech(OM_uint32 *, gss_const_OID, gss_OID_set *, gss_OID_set *);
...
OM_uint32 gssInquireSaslnameForMech(OM_uint32 *, const gss_OID, gss_buffer_t, gss_buffer_t, gss_buffer_t);
...
int gssrpcXdrRpcGssData(XDR *xdrs, xdrproc_t xdrFunc, caddr_t xdrPointer, gss_ctx_id_t ctx, gss_qop_t qop, rpc_gss_svc_t svc, uint32_t seq);
int gssrpcXdrRpcGWrapData(XDR *xdrs, xdrproc_t xdrFunc, caddr_t xdrPointer, gss_ctx_id_t ctx, gss_qop_t qop, rpc_gss_svc_t svc, uint32_t seq);
...
extern int gssrpcSvcRead(SVCXPRT *, rpcprog_t, rpcvers_t, void (*)(struct svc_req *, SVCXPRT *), int);
...
int gssrpcBindresvport(int sd, struct sockaddr_in *sockin)
{
  ...
  res = -1;
  errno = EADDRINUSE;
  for (i = 0; ((i < (((IPPORT_RESERVED - 1) - 600) + 1)) && (res < 0)) && (errno == EADDRINUSE); i++)
  {
    ...
    res = bind(sd, (struct sockaddr *) sockin, sizeof(struct sockaddr_in));
  }
