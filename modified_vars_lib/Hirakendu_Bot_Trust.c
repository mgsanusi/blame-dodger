...
int Main(int argc, char *argv[])
{
  ...
  for (case_id = 1; case_id <= no_case; case_id++)
  {
    ...
    {
      temp_i = fscanf(input_file_pointer, " %c %d", &button_color_lst[button_id - 1], &button_pos_lst[button_id - 1]);
    }
    ...
    if (verbose_level >= 3)
    {
      ...
      for (button_id = 1; button_id <= num_button; button_id++)
      {
        printf(" %c %d", button_color_lst[button_id - 1], button_pos_lst[button_id - 1]);
      }
    ...
    for (button_id = 1; button_id <= num_button; button_id++)
    {
      ...
      {
        orange_time += (button_pos_lst[button_id - 1] - orange_pos) > 0 ? button_pos_lst[button_id - 1] - orange_pos : -(button_pos_lst[button_id - 1] - orange_pos);
      ...
      {
        blue_time += (button_pos_lst[button_id - 1] - blue_pos) > 0 ? button_pos_lst[button_id - 1] - blue_pos : -(button_pos_lst[button_id - 1] - blue_pos);
