...
int dfs(int skipR, int skipC, int nowM)
{
  ...
  if ((nowM <= (((r - skipR) - 2) * ((c - skipC) - 2))) || (((nowM - (((r - skipR) - 2) * ((c - skipC) - 2))) % 2) == 0))
  {
    ...
    for (i = skipR; i < (r - 2); i++)
      for (aMin = skipC; (((((i - skipR) * ((c - skipC) - 2)) + aMin) - skipC) < nowM) && (aMin < (c - 2)); aMin++)
      grid[i][aMin] = '*';
    ...
    if (((nowM - (((r - skipR) - 2) * ((c - skipC) - 2))) - (((r - skipR) - 2) * 2)) > 0)
      for (aMin = skipC; ((((((r - skipR) - 2) * ((c - skipC) - 2)) + (((r - skipR) - 2) * 2)) + ((aMin - skipC) * 2)) < nowM) && (aMin < (c - 2)); aMin++)
