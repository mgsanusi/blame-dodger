...
typedef enum
{ RPCSEC_GSS_DATA = 0, RPCSEC_GSS_INIT = 1, RPCSEC_GSS_CONTINUE_INIT =
    2, RPCSEC_GSS_DESTROY = 3 } rpcGProcT;
typedef enum
{ RPCSEC_GSS_SVC_NONE = 1, RPCSEC_GSS_SVC_INTEGRITY =
...
enum auth_stat
{ AUTH_OK = 0, AUTH_BADCRED = 1, AUTH_REJECTEDCRED = 2, AUTH_BADVERF =
    3, AUTH_REJECTEDVERF = 4, AUTH_TOOWEAK = 5, AUTH_INVALIDRESP =
    6, AUTH_FAILED = 7, RPCSEC_GSS_CREDPROBLEM = 13, RPCSEC_GSS_CTXPROBLEM =
    14 };
union des_block
{
  char c[8];
...
enum clnt_stat
{ RPC_SUCCESS = 0, RPC_CANTENCODEARGS = 1, RPC_CANTDECODERES =
    2, RPC_CANTSEND = 3, RPC_CANTRECV = 4, RPC_TIMEDOUT =
    5, RPC_VERSMISMATCH = 6, RPC_AUTHERROR = 7, RPC_PROGUNAVAIL =
    8, RPC_PROGVERSMISMATCH = 9, RPC_PROCUNAVAIL = 10, RPC_CANTDECODEARGS =
    11, RPC_SYSTEMERROR = 12, RPC_UNKNOWNHOST = 13, RPC_UNKNOWNPROTO =
    17, RPC_PMAPFAILURE = 14, RPC_PROGNOTREGISTERED = 15, RPC_FAILED = 16 };
struct rpc_err
{
...
enum accept_stat
{ SUCCESS = 0, PROG_UNAVAIL = 1, PROG_MISMATCH = 2, PROC_UNAVAIL =
...
OM_uint32 gss_canonicalize_name (OM_uint32 *, const gss_name_t, const gss_OID,
				 gss_name_t *);
OM_uint32 gss_pseudo_random (OM_uint32 *, gss_ctx_id_t, int,
			     const gss_buffer_t, ssize_t, gss_buffer_t);
OM_uint32 gss_store_cred (OM_uint32 *, const gss_cred_id_t, gss_cred_usage_t,
...
typedef enum
{ RPCSEC_GSS_DATA = 0, RPCSEC_GSS_INIT = 1, RPCSEC_GSS_CONTINUE_INIT =
    2, RPCSEC_GSS_DESTROY = 3 } rpc_gss_proc_t;
typedef enum
{ RPCSEC_GSS_SVC_NONE = 1, RPCSEC_GSS_SVC_INTEGRITY =
...
int gssrpc_xdr_rpc_gss_data (XDR * xdrs, xdrproc_t xdr_func, caddr_t xdr_ptr,
...
extern int gssrpc_callrpc (char *, rpcprog_t, rpcvers_t, rpcproc_t, xdrproc_t,
			   char *, xdrproc_t, char *);
...
typedef struct CLIENT
{
  ...
  struct clnt_ops
  {
    enum clnt_stat (*clCall) (struct CLIENT *, rpcproc_t, xdrproc_t, void *,
			      xdrproc_t, void *, struct timeval);
...
OM_uint32 gssCanonicalizeName (OM_uint32 *, const gss_name_t, const gss_OID,
			       gss_name_t *);
OM_uint32 gssPseudoRandom (OM_uint32 *, gss_ctx_id_t, int, const gss_buffer_t,
...
int gssrpcXdrRpcGssWrapData (XDR * xdrs, xdrproc_t xdrFunc,
			     ...
			     gss_qop_t qop, rpc_gss_svc_t svc, uint32_t seq);
