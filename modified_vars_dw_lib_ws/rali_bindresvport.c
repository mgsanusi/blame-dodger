...
extern int gssrpcXdrArray(XDR *, caddr_t *, u_int *, u_int, u_int,
			  xdrproc_t);
...
OM_uint32 gssVerifyMic(OM_uint32 *, gss_ctx_id_t, gss_buffer_t,
		       gss_buffer_t, gss_qop_t *);
OM_uint32 gWrap(OM_uint32 *, gss_ctx_id_t, int, gss_qop_t, gss_buffer_t,
		int *, gss_buffer_t);
OM_uint32 gUnwrap(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t,
		  int *, gss_qop_t *);
OM_uint32 gssDisplayStatus(OM_uint32 *, OM_uint32, int, gss_OID,
			   OM_uint32 *, gss_buffer_t);
...
OM_uint32 gInquireCred(OM_uint32 *, gss_cred_id_t, gss_name_t *,
		       OM_uint32 *, gss_cred_usage_t *, gss_OID_set *);
OM_uint32 gInquireContext(OM_uint32 *, gss_ctx_id_t, gss_name_t *,
			  gss_name_t *, OM_uint32 *, gss_OID *,
			  OM_uint32 *, int *, int *);
...
OM_uint32 gssAddCred(OM_uint32 *, gss_cred_id_t, gss_name_t, gss_OID,
		     ...
		     gss_cred_id_t *, gss_OID_set *, OM_uint32 *,
		     OM_uint32 *);
OM_uint32 gInquireCredByMech(OM_uint32 *, gss_cred_id_t, gss_OID,
			     gss_name_t *, OM_uint32 *, OM_uint32 *,
			     gss_cred_usage_t *);
OM_uint32 gExportSecContext(OM_uint32 *, gss_ctx_id_t *, gss_buffer_t);
OM_uint32 gssImportSecondContext(OM_uint32 *, gss_buffer_t,
				 gss_ctx_id_t *);
...
OM_uint32 gssInquireMechsForName(OM_uint32 *, const gss_name_t,
				 gss_OID_set *);
OM_uint32 gSign(OM_uint32 *, gss_ctx_id_t, int, gss_buffer_t,
		gss_buffer_t);
OM_uint32 gVerify(OM_uint32 *, gss_ctx_id_t, gss_buffer_t, gss_buffer_t,
		  int *);
...
OM_uint32 gssInquireSaslnameForMech(OM_uint32 *, const gss_OID,
				    gss_buffer_t, gss_buffer_t,
				    gss_buffer_t);
OM_uint32 gInquireMechForSaslname(OM_uint32 *, const gss_buffer_t,
				  gss_OID *);
typedef enum { RPCSEC_GSS_DATA = 0, RPCSEC_GSS_INIT =
	1, RPCSEC_GSS_CONTINUE_INIT = 2, RPCSEC_GSS_DESTROY =
	3 } rpcGssProcT;
...
int gssrpcXdrRpcGssData(XDR * xdrs, xdrproc_t xdrFunc, caddr_t xdrPointer,
			...
			uint32_t seq);
int gssrpcXdrRpcGWrapData(XDR * xdrs, xdrproc_t xdrFunc,
