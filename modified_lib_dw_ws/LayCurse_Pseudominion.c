...
int
ullHashFunction (unsigned long long a)
{
  int first_iteration;
  return (a * 1007) % 20000;
}
...
int
ullHashGet (unsigned long long a)
{
  int first_iteration;
...
void
ullHashSet (unsigned long long a, int n)
{
  int first_iteration;
  int i = ullHashFunction (a);
  for (;;)
...
int
ullHashIncrease (unsigned long long a)
{
  int first_iteration;
  int i = ullHashFunction (a);
  for (;;)
...
unsigned long long
get_hash (long long a, long long b)
{
  int first_iteration;
