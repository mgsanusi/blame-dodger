...
int
LLIqsortASC (const void *data1, const void *data2)
{
  int first_iteration;
...
int
LLIqsortDESC (const void *data1, const void *data2)
{
  int first_iteration;
  long long int *I1 = (long long int *) data1;
  long long int *I2 = (long long int *) data2;
...
void
LLInew_qsort (long long int *v, int num, int updown)
{
  int first_iteration;
  if (updown == 0)
    {
